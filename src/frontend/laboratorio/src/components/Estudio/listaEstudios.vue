    ...
    <div v-else>
        <b-col lg="4" class="my-1">
            <b-input-group size="sm">
                <b-form-input id="filter-input" v-model="filter" type="search" placeholder="Buscar por nombre de paciente,medico derivante u diagnostico"></b-form-input>
        ...
        <b-table :items="items" :fields="fields" :filter="filter" :current-page="currentPage" :per-page="perPage" @filtered="onFiltered">
            ...
            <template v-slot:cell(acciones)="row">
                ...
                <div v-if="esUltimoEstado(row.item)">
                    <b-button @click="siguienteEstado(row.item)" variant="outline-white" title="Siguiente estado">
        ...
        <b-row>
            <b-col>
                <b-form-select style="width:150px" id="per-page-select" v-model="perPage" :options="pageOptions" size="sm"></b-form-select>
            </b-col>
            <b-col>
...
export default {
    ...
    methods: {
        obtenerUltimoEstado(estudio) {
            // let nameEstado = estudio.estados[paciente.estados.length - 1].resourcetype;
